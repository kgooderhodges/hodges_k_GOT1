...
function showLightbox() {
    ...
    let targetSource = `video/House-${targetSource}.mp4`;
...
function animateBanners () {
    // clicking on the sheild should trigger an animation
    // figure out how far the banners should move with some simple math... blarg
    ...
    let newPosition = offsetWidth * this.dataset.offset;
...
sigilButtons.forEach(buttons => buttons.addEventListener ('click', animateBanners));
